...
export const generateBlogRss = (blogData, rssDescription, locale) => `
  <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
      <title>Blog - RSS feed (${locale})</title>
      <link>http://natalia-vale-asari-v2.vercel.app/${locale}/blog</link>
      <description>${rssDescription}</description>
      <language>${locale}</language>
      <lastBuildDate>${new Date(blogData[0].date).toUTCString()}</lastBuildDate>
      <atom:link href="http://natalia-vale-asari-v2.vercel.app/rss/blog-${locale}.xml" rel="self" type="application/rss+xml"/>
...
const generateBlogRssItem = (post) => `
  <item>
     <guid isPermaLink="true">http://natalia-vale-asari-v2.vercel.app/${post.locale}/blog/${post.id}</guid>
     <title>${post.title}</title>
     <link>http://natalia-vale-asari-v2.vercel.app/${post.locale}/blog/${post.id}</link>
