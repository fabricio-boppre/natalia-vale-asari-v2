...
export default function BlogHeader(props) {
  ...
  const {locale} = router
  const feedUrl = "/rss/blog-" + locale + ".xml"

	return <div id={styles.blog_header}>

             <h2>{props.title}</h2>

             <Link href={feedUrl} >
               <a className="rss">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 24.332 24.332">
                  	<g>
